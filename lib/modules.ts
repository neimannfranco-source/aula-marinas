...
},
{
...
},
 {
  ...
  emoji: "🌳",
  phrases: [
    { pt: "O Bosque de Arrayanes é uma das excursões mais famosas da região", es: "El Bosque de Arrayanes es una de las excursiones más famosas de la región" },
    { pt: "Você pode visitá-lo de catamarã", es: "Puede visitarlo en catamarán" },
    { pt: "Também é possível ir caminhando ou de bicicleta", es: "También es posible ir caminando o en bicicleta" },
    { pt: "A trilha tem aproximadamente doze quilômetros", es: "El sendero tiene aproximadamente doce kilómetros" },
    { pt: "É uma experiência muito bonita e diferente", es: "Es una experiencia muy linda y diferente" },
    { pt: "A floresta de arrayanes é única e muito especial", es: "El bosque de arrayanes es único y muy especial" },
    { pt: "O passeio de catamarã dura cerca de três horas", es: "El paseo en catamarán dura alrededor de tres horas" },
    { pt: "Recomendamos reservar com antecedência", es: "Recomendamos reservar con anticipación" },
    { pt: "É uma excursão ideal para quem gosta de natureza", es: "Es una excursión ideal para quienes gustan de la naturaleza" },
    { pt: "A paisagem durante o trajeto é incrível", es: "El paisaje durante el trayecto es increíble" },
    { pt: "É recomendável levar casaco e água", es: "Es recomendable llevar abrigo y agua" },
    { pt: "Podemos ajudar com a reserva da excursão", es: "Podemos ayudar con la reserva de la excursión" },
  ],
  vocab: [
    { pt: "bosque", es: "bosque" },
    { pt: "arrayanes", es: "arrayanes" },
    { pt: "catamarã", es: "catamarán" },
    { pt: "trilha", es: "sendero" },
    { pt: "bicicleta", es: "bicicleta" },
    { pt: "natureza", es: "naturaleza" },
    { pt: "paisagem", es: "paisaje" },
    { pt: "trajeto", es: "trayecto" },
    { pt: "reserva", es: "reserva" },
    { pt: "antecedência", es: "anticipación" },
    { pt: "casaco", es: "abrigo" },
    { pt: "água", es: "agua" },
  ...
  dialogue: [
    { speaker: "Hóspede", pt: "Vocês recomendam alguma excursão diferente?", es: "¿Recomiendan alguna excursión diferente?" },
    { speaker: "Colaborador", pt: "Sim, recomendamos muito o Bosque de Arrayanes", es: "Sí, recomendamos mucho el Bosque de Arrayanes" },
    { speaker: "Hóspede", pt: "Como posso visitar?", es: "¿Cómo puedo visitarlo?" },
    { speaker: "Colaborador", pt: "Pode ir de catamarã ou também caminhando e de bicicleta", es: "Puede ir en catamarán o también caminando y en bicicleta" },
    { speaker: "Hóspede", pt: "Quanto tempo dura o passeio?", es: "¿Cuánto dura el paseo?" },
    { speaker: "Colaborador", pt: "De catamarã, dura cerca de três horas", es: "En catamarán dura alrededor de tres horas" },
  ],
  quiz: [
    {
      question: "¿Cómo se puede visitar el Bosque de Arrayanes?",
      options: ["Solo en auto", "En catamarán, caminando o en bicicleta", "Solo a caballo"],
      answer: "En catamarán, caminando o en bicicleta",
    },
    {
      question: "¿Cuánto dura aproximadamente el paseo en catamarán?",
      options: ["Treinta minutos", "Tres horas", "Todo el día"],
      answer: "Tres horas",
    },
  ],
},
{
  id: "miradores_trekking",
  title: "Miradores y Trekking",
  category: "Excursiones",
  emoji: "🥾",
  phrases: [
    { pt: "Há mirantes com vistas panorâmicas incríveis", es: "Hay miradores con vistas panorámicas increíbles" },
    { pt: "O Mirador Belvedere é um dos mais recomendados", es: "El Mirador Belvedere es uno de los más recomendados" },
    { pt: "Também pode visitar a cascata durante o percurso", es: "También puede visitar la cascada durante el recorrido" },
    { pt: "É ideal para quem gosta de trekking e natureza", es: "Es ideal para quienes gustan del trekking y la naturaleza" },
    { pt: "A caminhada é de dificuldade leve a moderada", es: "La caminata es de dificultad leve a moderada" },
    { pt: "Recomendamos usar calçado confortável", es: "Recomendamos usar calzado cómodo" },
    { pt: "É importante levar água e protetor solar", es: "Es importante llevar agua y protector solar" },
    { pt: "As vistas do Lago Correntoso são espetaculares", es: "Las vistas del Lago Correntoso son espectaculares" },
    { pt: "É uma excelente opção para o verão", es: "Es una excelente opción para el verano" },
    { pt: "Pode ser uma excursão curta e muito bonita", es: "Puede ser una excursión corta y muy linda" },
    { pt: "Há trilhas para diferentes níveis", es: "Hay senderos para diferentes niveles" },
    { pt: "Podemos indicar a melhor opção para você", es: "Podemos indicar la mejor opción para usted" },
  ],
  vocab: [
    { pt: "mirante", es: "mirador" },
    { pt: "vista panorâmica", es: "vista panorámica" },
    { pt: "cascata", es: "cascada" },
    { pt: "caminhada", es: "caminata" },
    { pt: "dificuldade", es: "dificultad" },
    { pt: "leve", es: "leve" },
    { pt: "moderada", es: "moderada" },
  ...
  dialogue: [
    { speaker: "Hóspede", pt: "Há alguma caminhada com boa vista?", es: "¿Hay alguna caminata con buena vista?" },
    { speaker: "Colaborador", pt: "Sim, recomendamos o Mirador Belvedere", es: "Sí, recomendamos el Mirador Belvedere" },
    { speaker: "Hóspede", pt: "É muito difícil?", es: "¿Es muy difícil?" },
    { speaker: "Colaborador", pt: "Não, é de dificuldade leve a moderada", es: "No, es de dificultad leve a moderada" },
    { speaker: "Hóspede", pt: "Preciso levar algo especial?", es: "¿Necesito llevar algo especial?" },
    { speaker: "Colaborador", pt: "Sim, água, protetor solar e calçado confortável", es: "Sí, agua, protector solar y calzado cómodo" },
  ],
  quiz: [
    {
      question: "¿Qué mirador es uno de los más recomendados?",
      options: ["Belvedere", "Arrayanes", "Messidor"],
      answer: "Belvedere",
    },
    {
      question: "¿Qué se recomienda llevar?",
      options: ["Solo una cámara", "Agua y calzado cómodo", "Solo traje de baño"],
      answer: "Agua y calzado cómodo",
    },
  ],
},
{
  id: "lago_rio_correntoso",
  title: "Lago y Río Correntoso",
  category: "Excursiones",
  emoji: "🌊",
  phrases: [
    { pt: "O Lago Correntoso é ideal para relaxar e aproveitar a paisagem", es: "El Lago Correntoso es ideal para relajarse y disfrutar el paisaje" },
    { pt: "O Rio Correntoso é considerado um dos mais curtos do mundo", es: "El Río Correntoso es considerado uno de los más cortos del mundo" },
    { pt: "A região é perfeita para pesca e kayak", es: "La zona es perfecta para pesca y kayak" },
    { pt: "Também há praias muito bonitas e tranquilas", es: "También hay playas muy lindas y tranquilas" },
    { pt: "É uma ótima opção para passar o dia", es: "Es una gran opción para pasar el día" },
    { pt: "As águas são muito bonitas e cristalinas", es: "Las aguas son muy lindas y cristalinas" },
    { pt: "É um lugar muito procurado no verão", es: "Es un lugar muy buscado en verano" },
    { pt: "Pode combinar descanso e atividades ao ar livre", es: "Puede combinar descanso y actividades al aire libre" },
    { pt: "A paisagem é muito tranquila e natural", es: "El paisaje es muy tranquilo y natural" },
    { pt: "Recomendamos visitar com tempo e calma", es: "Recomendamos visitar con tiempo y calma" },
    { pt: "É ideal para casais e famílias", es: "Es ideal para parejas y familias" },
    { pt: "Podemos indicar os melhores acessos", es: "Podemos indicar los mejores accesos" },
  ],
  vocab: [
    { pt: "rio", es: "río" },
    { pt: "lago", es: "lago" },
    ...
    { pt: "kayak", es: "kayak" },
    { pt: "praia", es: "playa" },
    { pt: "água cristalina", es: "agua cristalina" },
    { pt: "verão", es: "verano" },
    { pt: "paisagem", es: "paisaje" },
    { pt: "descanso", es: "descanso" },
    { pt: "família", es: "familia" },
    { pt: "casal", es: "pareja" },
    { pt: "acesso", es: "acceso" },
  ],
  dialogue: [
    { speaker: "Hóspede", pt: "O que podemos fazer no Lago Correntoso?", es: "¿Qué podemos hacer en el Lago Correntoso?" },
    { speaker: "Colaborador", pt: "Podem relaxar, fazer kayak ou aproveitar a praia", es: "Pueden relajarse, hacer kayak o disfrutar la playa" },
    { speaker: "Hóspede", pt: "E o Rio Correntoso vale a visita?", es: "¿Y el Río Correntoso vale la visita?" },
    { speaker: "Colaborador", pt: "Sim, muito. É um dos rios mais curtos do mundo", es: "Sí, mucho. Es uno de los ríos más cortos del mundo" },
    { speaker: "Hóspede", pt: "É uma boa opção para passar o dia?", es: "¿Es una buena opción para pasar el día?" },
    { speaker: "Colaborador", pt: "Sim, é uma opção muito bonita e tranquila", es: "Sí, es una opción muy linda y tranquila" },
  ],
  quiz: [
    {
      question: "¿Para qué actividades es ideal la zona?",
      options: ["Pesca y kayak", "Solo esquí", "Solo compras"],
      answer: "Pesca y kayak",
    },
    {
      question: "¿Cómo es conocido el Río Correntoso?",
      options: ["Por ser el más profundo", "Por ser uno de los más cortos del mundo", "Por ser artificial"],
      answer: "Por ser uno de los más cortos del mundo",
    },
  ],
},
{
  id: "bahia_mansa_brava",
  title: "Bahía Mansa y Brava",
  category: "Excursiones",
  emoji: "🏖️",
  phrases: [
    { pt: "Bahía Mansa é tranquila e muito agradável", es: "Bahía Mansa es tranquila y muy agradable" },
    { pt: "Bahía Brava tem mais vento e um ambiente diferente", es: "Bahía Brava tiene más viento y un ambiente diferente" },
    { pt: "As duas ficam perto do centro", es: "Las dos quedan cerca del centro" },
    { pt: "São ótimas para passear e tirar fotos", es: "Son excelentes para pasear y sacar fotos" },
    { pt: "Bahía Mansa é ideal para descansar", es: "Bahía Mansa es ideal para descansar" },
    { pt: "Bahía Brava costuma ter mais movimento do vento", es: "Bahía Brava suele tener más movimiento del viento" },
    { pt: "São lugares muito bonitos para conhecer", es: "Son lugares muy lindos para conocer" },
    { pt: "Pode visitar as duas no mesmo dia", es: "Puede visitar las dos el mismo día" },
    { pt: "O acesso é fácil a partir da cidade", es: "El acceso es fácil desde la ciudad" },
    { pt: "Recomendamos para um passeio tranquilo", es: "Recomendamos para un paseo tranquilo" },
    { pt: "A vista do lago é maravilhosa", es: "La vista del lago es maravillosa" },
    { pt: "É uma visita clássica em Villa La Angostura", es: "Es una visita clásica en Villa La Angostura" },
  ],
  vocab: [
    { pt: "baía", es: "bahía" },
    { pt: "tranquila", es: "tranquila" },
    { pt: "vento", es: "viento" },
    { pt: "centro", es: "centro" },
    { pt: "passeio", es: "paseo" },
    { pt: "foto", es: "foto" },
    ...
    { pt: "vista", es: "vista" },
    { pt: "lago", es: "lago" },
    { pt: "clássico", es: "clásico" },
    { pt: "cidade", es: "ciudad" },
  ],
  dialogue: [
    { speaker: "Hóspede", pt: "Qual a diferença entre Bahía Mansa e Bahía Brava?", es: "¿Cuál es la diferencia entre Bahía Mansa y Bahía Brava?" },
    { speaker: "Colaborador", pt: "Bahía Mansa é mais tranquila, e Bahía Brava tem mais vento", es: "Bahía Mansa es más tranquila, y Bahía Brava tiene más viento" },
    { speaker: "Hóspede", pt: "Ficam longe do centro?", es: "¿Quedan lejos del centro?" },
    { speaker: "Colaborador", pt: "Não, ficam bastante perto e o acesso é fácil", es: "No, quedan bastante cerca y el acceso es fácil" },
    { speaker: "Hóspede", pt: "Vale a pena visitar as duas?", es: "¿Vale la pena visitar las dos?" },
    { speaker: "Colaborador", pt: "Sim, são muito bonitas e diferentes entre si", es: "Sí, son muy lindas y diferentes entre sí" },
  ],
  quiz: [
    {
      question: "¿Cuál es más tranquila?",
      options: ["Bahía Mansa", "Bahía Brava", "Las dos son iguales"],
      answer: "Bahía Mansa",
    },
    {
      question: "¿Qué tiene más viento?",
      options: ["Bahía Brava", "Bahía Mansa", "El centro"],
      answer: "Bahía Brava",
    },
  ],
},
{
  id: "cerro_bayo_verano_invierno",
  title: "Cerro Bayo verano e invierno",
  category: "Excursiones",
  emoji: "⛷️",
  phrases: [
    { pt: "O Cerro Bayo é uma das principais atrações da região", es: "El Cerro Bayo es una de las principales atracciones de la región" },
    { pt: "No inverno é ideal para ski e snowboard", es: "En invierno es ideal para ski y snowboard" },
    { pt: "No verão há trilhas e vistas panorâmicas", es: "En verano hay senderos y vistas panorámicas" },
    { pt: "Também há atividades como mountain bike", es: "También hay actividades como mountain bike" },
    { pt: "A vista do topo é espetacular", es: "La vista desde la cima es espectacular" },
    { pt: "É uma ótima opção em qualquer estação", es: "Es una gran opción en cualquier estación" },
    { pt: "Podemos ajudar a organizar a visita", es: "Podemos ayudar a organizar la visita" },
    { pt: "No inverno recomendamos ir cedo", es: "En invierno recomendamos ir temprano" },
    { pt: "No verão é excelente para passeios e natureza", es: "En verano es excelente para paseos y naturaleza" },
    { pt: "Há opções para diferentes níveis", es: "Hay opciones para diferentes niveles" },
    { pt: "É uma excursão muito recomendada", es: "Es una excursión muy recomendada" },
    { pt: "Também há restaurantes e serviços no local", es: "También hay restaurantes y servicios en el lugar" },
  ],
  vocab: [
    { pt: "inverno", es: "invierno" },
    { pt: "verão", es: "verano" },
  ...
  dialogue: [
    { speaker: "Hóspede", pt: "O Cerro Bayo vale a pena no verão?", es: "¿El Cerro Bayo vale la pena en verano?" },
    { speaker: "Colaborador", pt: "Sim, muito. Há trilhas, vistas panorâmicas e natureza", es: "Sí, mucho. Hay senderos, vistas panorámicas y naturaleza" },
    { speaker: "Hóspede", pt: "E no inverno?", es: "¿Y en invierno?" },
    { speaker: "Colaborador", pt: "No inverno é ideal para ski e snowboard", es: "En invierno es ideal para ski y snowboard" },
    { speaker: "Hóspede", pt: "Tem atividades para todos?", es: "¿Hay actividades para todos?" },
    { speaker: "Colaborador", pt: "Sim, há opções para diferentes níveis e idades", es: "Sí, hay opciones para diferentes niveles y edades" },
  ],
  quiz: [
    {
      question: "¿Qué se puede hacer en invierno en Cerro Bayo?",
      options: ["Ski y snowboard", "Solo kayak", "Solo compras"],
      answer: "Ski y snowboard",
    },
    {
      question: "¿Qué hay en verano?",
      options: ["Solo nieve", "Trilhas e vistas panorámicas", "Nada para hacer"],
      answer: "Trilhas e vistas panorámicas",
    },
  ],
},
{
  id: "ruta_7_lagos",
  title: "Ruta de los 7 Lagos",
  category: "Excursiones",
  emoji: "🚗",
  phrases: [
    { pt: "A Ruta dos 7 Lagos é uma excursão clássica da região", es: "La Ruta de los 7 Lagos es una excursión clásica de la región" },
    { pt: "O trajeto vai até San Martín de los Andes", es: "El recorrido va hasta San Martín de los Andes" },
    { pt: "É um passeio muito panorâmico", es: "Es un paseo muy panorámico" },
    { pt: "Durante o caminho, você vê vários lagos", es: "Durante el camino, ve varios lagos" },
    { pt: "A estrada é uma das mais bonitas da Patagônia", es: "La ruta es una de las más lindas de la Patagonia" },
    { pt: "Recomendamos sair cedo para aproveitar melhor", es: "Recomendamos salir temprano para aprovechar mejor" },
    { pt: "Pode ser feito de carro ou com excursão", es: "Se puede hacer en auto o con excursión" },
    { pt: "É ideal para um passeio de dia inteiro", es: "Es ideal para un paseo de día completo" },
    { pt: "As paisagens mudam muito ao longo do caminho", es: "Los paisajes cambian mucho a lo largo del camino" },
    { pt: "É uma das excursões mais procuradas", es: "Es una de las excursiones más buscadas" },
    { pt: "Vale muito a pena em qualquer época do ano", es: "Vale mucho la pena en cualquier época del año" },
    { pt: "Podemos ajudar a organizar a saída", es: "Podemos ayudar a organizar la salida" },
  ],
  vocab: [
    { pt: "rota", es: "ruta" },
    { pt: "lago", es: "lago" },
    { pt: "estrada", es: "ruta" },
    { pt: "trajeto", es: "recorrido" },
    { pt: "panorâmico", es: "panorámico" },
    { pt: "carro", es: "auto" },
    { pt: "excursão", es: "excursión" },
    { pt: "dia inteiro", es: "día completo" },
    { pt: "paisagem", es: "paisaje" },
    { pt: "Patagônia", es: "Patagonia" },
    { pt: "saída", es: "salida" },
    { pt: "época", es: "época" },
  ...
  dialogue: [
    { speaker: "Hóspede", pt: "A Ruta dos 7 Lagos é recomendada?", es: "¿La Ruta de los 7 Lagos es recomendada?" },
    { speaker: "Colaborador", pt: "Sim, é uma das excursões mais bonitas da região", es: "Sí, es una de las excursiones más lindas de la región" },
    { speaker: "Hóspede", pt: "Demora muito?", es: "¿Demora mucho?" },
    { speaker: "Colaborador", pt: "É melhor fazer como passeio de dia inteiro", es: "Es mejor hacerla como paseo de día completo" },
    { speaker: "Hóspede", pt: "Pode ser feita de carro?", es: "¿Se puede hacer en auto?" },
    { speaker: "Colaborador", pt: "Sim, de carro ou com excursão organizada", es: "Sí, en auto o con excursión organizada" },
  ],
  quiz: [
    {
      question: "¿Hasta dónde llega la Ruta de los 7 Lagos?",
      options: ["Bariloche", "San Martín de los Andes", "Neuquén"],
      answer: "San Martín de los Andes",
    },
    {
      question: "¿Cómo se recomienda hacerla?",
      options: ["En una hora", "Como paseo de día entero", "Solo de noche"],
      answer: "Como paseo de día entero",
    },
  ],
},
{
  id: "kayak_aventura",
  title: "Kayak y Aventura",
  category: "Excursiones",
  emoji: "🛶",
  phrases: [
    { pt: "Há travessias de kayak muito bonitas na região", es: "Hay travesías de kayak muy lindas en la región" },
    { pt: "Muitas saídas acontecem desde Bahía Mansa", es: "Muchas salidas se hacen desde Bahía Mansa" },
    { pt: "É uma atividade ideal para quem gosta de aventura", es: "Es una actividad ideal para quienes gustan de la aventura" },
    { pt: "A experiência no lago é muito especial", es: "La experiencia en el lago es muy especial" },
    { pt: "Normalmente inclui guia e equipamento", es: "Normalmente incluye guía y equipamiento" },
    { pt: "Recomendamos verificar o clima antes", es: "Recomendamos verificar el clima antes" },
    { pt: "É uma atividade segura e muito bonita", es: "Es una actividad segura y muy linda" },
    { pt: "Pode ser feita por iniciantes em algumas opções", es: "Puede hacerse por principiantes en algunas opciones" },
    { pt: "É uma excelente maneira de conhecer o lago", es: "Es una excelente manera de conocer el lago" },
    { pt: "Também há experiências mais aventureiras", es: "También hay experiencias más aventureras" },
    { pt: "Recomendamos reservar com antecedência", es: "Recomendamos reservar con anticipación" },
    { pt: "Podemos indicar a melhor opção para você", es: "Podemos indicar la mejor opción para usted" },
  ],
  vocab: [
    ...
    { pt: "guia", es: "guía" },
    { pt: "equipamento", es: "equipamiento" },
    { pt: "clima", es: "clima" },
    { pt: "seguro", es: "seguro" },
    { pt: "iniciante", es: "principiante" },
    { pt: "lago", es: "lago" },
    { pt: "travessia", es: "travesía" },
    { pt: "reserva", es: "reserva" },
    { pt: "antecedência", es: "anticipación" },
    { pt: "atividade", es: "actividad" },
  ],
  dialogue: [
    { speaker: "Hóspede", pt: "Há alguma atividade de aventura no lago?", es: "¿Hay alguna actividad de aventura en el lago?" },
    { speaker: "Colaborador", pt: "Sim, recomendamos muito as travessias de kayak", es: "Sí, recomendamos mucho las travesías de kayak" },
    { speaker: "Hóspede", pt: "É uma atividade difícil?", es: "¿Es una actividad difícil?" },
    { speaker: "Colaborador", pt: "Depende da opção, mas há alternativas para iniciantes", es: "Depende de la opción, pero hay alternativas para principiantes" },
    { speaker: "Hóspede", pt: "Inclui guia e equipamento?", es: "¿Incluye guía y equipamiento?" },
    { speaker: "Colaborador", pt: "Sim, normalmente inclui ambos", es: "Sí, normalmente incluye ambos" },
  ],
  quiz: [
    {
    ...
    },
    {
      ...
      options: ["Solo expertos", "También iniciantes", "Solo niños"],
      answer: "También iniciantes",
    },
  ],
},
{
  id: "centro_puntos_culturales",
  title: "Centro y puntos culturales",
  category: "Excursiones",
  emoji: "🏘️",
  phrases: [
    { pt: "O centro de Villa La Angostura é muito bonito para passear", es: "El centro de Villa La Angostura es muy lindo para pasear" },
    { pt: "Você pode conhecer pontos históricos e culturais", es: "Puede conocer puntos históricos y culturales" },
    { pt: "El Messidor é um castelo de estilo francês", es: "El Messidor es un castillo de estilo francés" },
    { pt: "Pode ser visto de fora durante o passeio", es: "Se puede ver desde afuera durante el paseo" },
    { pt: "A capela é um ponto histórico importante", es: "La capilla es un punto histórico importante" },
    { pt: "A Laguna Verde é uma reserva natural muito tranquila", es: "La Laguna Verde es una reserva natural muy tranquila" },
    { pt: "Há passarelas para caminhar e observar aves", es: "Hay pasarelas para caminar y observar aves" },
    { pt: "É um passeio ideal para quem prefere algo calmo", es: "Es un paseo ideal para quienes prefieren algo tranquilo" },
    { pt: "Pode combinar natureza e cultura no mesmo dia", es: "Puede combinar naturaleza y cultura en el mismo día" },
    { pt: "É uma boa opção para toda a família", es: "Es una buena opción para toda la familia" },
    { pt: "O centro também tem lojas e cafés", es: "El centro también tiene tiendas y cafés" },
    { pt: "Podemos indicar um roteiro tranquilo pela cidade", es: "Podemos indicar un recorrido tranquilo por la ciudad" },
  ],
  vocab: [
    { pt: "centro", es: "centro" },
    { pt: "castelo", es: "castillo" },
    { pt: "capela", es: "capilla" },
    { pt: "histórico", es: "histórico" },
    { pt: "cultural", es: "cultural" },
    { pt: "reserva natural", es: "reserva natural" },
    { pt: "passarela", es: "pasarela" },
    { pt: "aves", es: "aves" },
    { pt: "família", es: "familia" },
    { pt: "loja", es: "tienda" },
    { pt: "café", es: "café" },
    { pt: "roteiro", es: "recorrido" },
  ],
  dialogue: [
    { speaker: "Hóspede", pt: "Há algum passeio cultural no centro?", es: "¿Hay algún paseo cultural en el centro?" },
    { speaker: "Colaborador", pt: "Sim, você pode conhecer El Messidor, a capela e a Laguna Verde", es: "Sí, puede conocer El Messidor, la capilla y la Laguna Verde" },
    { speaker: "Hóspede", pt: "É um passeio tranquilo?", es: "¿Es un paseo tranquilo?" },
    { speaker: "Colaborador", pt: "Sim, é ideal para caminhar com calma e aproveitar a cidade", es: "Sí, es ideal para caminar con calma y disfrutar la ciudad" },
    { speaker: "Hóspede", pt: "Também há natureza nesse passeio?", es: "¿También hay naturaleza en ese paseo?" },
    { speaker: "Colaborador", pt: "Sim, a Laguna Verde é uma reserva natural muito bonita", es: "Sí, la Laguna Verde es una reserva natural muy linda" },
  ],
  quiz: [
    {
      question: "¿Qué es El Messidor?",
      options: ["Um castelo", "Uma praia", "Um restaurante"],
      answer: "Um castelo",
    },
    {
      question: "¿Qué se puede hacer en Laguna Verde?",
      options: ["Esquiar", "Observar aves e caminhar", "Andar de teleférico"],
      answer: "Observar aves e caminhar",
    },
  ],
},
